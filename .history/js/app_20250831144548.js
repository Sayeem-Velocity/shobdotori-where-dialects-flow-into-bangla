...
startBtn.onclick = async () => {
  ...
  mediaRecorder.onstop = () => {
    ...
    // Create dialect folder path
    const fileName = `${dialect}_train (${fileIndex++}).wav`;
    const a = document.createElement("a");
    a.href = url;
    a.download = `audio/${dialect}/${fileName}`;
    a.click();
  };

  status.textContent = "রেকর্ড হচ্ছে... এখন একটি বাক্য পড়ুন।";
