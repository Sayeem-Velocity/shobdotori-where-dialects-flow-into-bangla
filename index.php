<?php
// Backend URL: if hosted on same XAMPP server, use localhost.
// Later you can replace with ngrok/public host when deploying.
$BACKEND_URL = "http://localhost/shobdotori";
?>
<!DOCTYPE html>
<html lang="bn">
<head>
  ...
  <title>শব্দতরী : Where Dialects flow into Bangla</title>
...
<body>
  ...
  <div class="container">
    <h1 class="title">"শব্দতরী : Where Dialects flow into Bangla"</h1>

    <!-- Dropdown -->
    <div class="dropdown">
      <label for="dialect">উপভাষা নির্বাচন করুন:</label>
      <select id="dialect">
        ...
        <option value="sandwip">সন্দ্বীপ</option>
      </select>
    ...
    <!-- Sentences -->
    <div id="sentences" class="sentence-box"></div>

    <!-- Recorder -->
    <div class="recorder">
      <p><b>নির্দেশনা:</b> প্রতিটি রেকর্ডে কেবলমাত্র একটি বাক্য পড়ুন।  
      "রেকর্ড শুরু" চাপুন → একটি বাক্য পড়ুন → তারপর "রেকর্ড শেষ" চাপুন।</p>

      <button id="startBtn">রেকর্ড শুরু</button>
      <button id="stopBtn" disabled>রেকর্ড শেষ</button>
      <p id="status">রেকর্ড করার জন্য শুরু চাপুন</p>
    </div>
  </div>

  <!-- Floating Recording Box -->
  <div id="recordingBox" class="recording-box hidden">
    <div class="dot"></div>
    <span id="recordingText">রেকর্ড হচ্ছে... একটি মাত্র বাক্য পড়ুন</span>
  </div>

  <!-- Backend URL injection -->
  <script>
    window.APP_CONFIG = { BACKEND_URL: "<?php echo htmlspecialchars($BACKEND_URL, ENT_QUOTES); ?>" };
  </script>
